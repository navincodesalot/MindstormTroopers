...
import static com.example.meepmeeptesting.BaseMeep.leftRedStartPose;
...
//                                                }
                                            ...
                                            .lineToSplineHeading(new Pose2d(pickX1, returnY(pickY1), Math.toRadians(returnHead(pickHead1))))
                                            .addSpatialMarker(new Vector2d(pickX1, returnY(pickY1)), () -> {
...
//                                               slideTarget = sLow;
                                            ...
                                            .lineToSplineHeading(new Pose2d(dropX, returnY(dropY), Math.toRadians(dropHead)))
...
//                                                }
                                            ...
                                            .waitSeconds(1)
                                            .addSpatialMarker(new Vector2d(dropX, returnY(dropY)), () -> {
//                                                   if (Math.abs(arm.getCurrentPosition() - armTarget) < 5) {
//                                                        claw.setPosition(1);
//                                                        armTarget = aStatic;
//                                                        if (Math.abs(arm.getCurrentPosition() - armTarget) < 5) {
...
//                                                }
                                            ...
                                            .waitSeconds(1)
                                            .addSpatialMarker(new Vector2d(pickX, returnY(dropY)), () -> {
//                                                   if (Math.abs(arm.getCurrentPosition() - armTarget) < 5) {
//                                                        claw.setPosition(1);
//                                                        armTarget = aStatic;
//                                                        if (Math.abs(arm.getCurrentPosition() - armTarget) < 5) {
...
//                                           PARK
                                            .lineToSplineHeading(new Pose2d(12, returnY(13), Math.toRadians(-90)))
                                            .UNSTABLE_addTemporalMarkerOffset(0.5, () -> {
//                                                slideTarget = sLow;
                                            })
                                            .build()
...
//                                               }
                                            ...
                                            // PARK
                                            .lineToConstantHeading(new Vector2d(35, returnY(12)))
                                            .UNSTABLE_addTemporalMarkerOffset(0.5, () -> {
//                                                slideTarget = sLow;
                                            })
                                            .lineToConstantHeading(new Vector2d(35, returnY(33)))
                                            .lineToLinearHeading(new Pose2d(60, returnY(35), Math.toRadians(-90)))
                                            .build()
                    );
            meepMeep.setBackground(MeepMeep.Background.FIELD_POWERPLAY_OFFICIAL)
                    .setDarkMode(true)
