...
//    private final SlideSubsystem drop;
//    private final DoubleSupplier forwardSpeed, strafeSpeed, turnSpeed, gyroAngle;
//    private final boolean clip;
//
//    public DriveFieldCommand(MecanumDriveSubsystem drive, SlideSubsystem drop, DoubleSupplier strafeSpeed, DoubleSupplier forwardSpeed, DoubleSupplier turnSpeed, DoubleSupplier gyroAngle, boolean clip) {
//        this.drive = drive;
//        this.drop = drop;
