...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(4, 0, 0.75);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(6, 0, 1);

    public static double LATERAL_MULTIPLIER = 1.34728324;
    ...
    // Two Wheel Constructor for teleop (less drifting)
    public SampleMecanumDrive(boolean useTwoWheelLocalization, HardwareMap hardwareMap) {
        super(kV, kA, kStatic, TRACK_WIDTH, TRACK_WIDTH, LATERAL_MULTIPLIER);
