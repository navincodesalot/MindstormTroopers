...
public class CachingDcMotorSimple extends CachingHardwareDevice implements DcMotorSimple {
	...
	/**
	 * Default constructor for the cached simple motor, sets the threshold to 0.005
	 *
	...
	public CachingDcMotorSimple(DcMotorSimple motorSimple) {
		this(motorSimple, 0.005); // todo: find best, kooky uses 0.005. --> the lower, the more precision, but more hardware writes
	}
	 ...
	 *
	 * @return the current changeThreshold value, defaults to 0.005
	 */
